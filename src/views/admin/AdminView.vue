<script setup>
    import usePropiedades from '@/components/usePropiedades';
    import {price} from '../../helpers/index.js'
    const {propiedadesCollection, deleteItems} = usePropiedades()
</script>
    ...
    <v-card class="mx-auto mt-10" flat>
        <v-list>
            ...
            >
                ...
                <v-list-item-subtitle>{{ price(propiedad.precio) }}</v-list-item-subtitle>
                ...
                <template v-slot:append>
                    ...
                    <v-btn
                        color="red-darken-3"
                        flat
                        @click="deleteItems(propiedad.id, propiedad.imagen)"
                    >
                        Eliminar
                    </v-btn>
                </template>
